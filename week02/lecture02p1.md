...
<!-- .slide: data-background-image="../week03/images/stitch_nobg_tilted.png" data-background-size="contain"-->
...
We'll start with manipulating tabular data, then image data and then move on to geographical (GIS/spatial) data in a few lectures.
